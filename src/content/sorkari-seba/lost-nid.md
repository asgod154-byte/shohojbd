...
steps:
  ...
  - title: "ধাপ ৩: ফি পরিশোধ ও ভেরিফিকেশন"
    description: "নির্ধারিত ফি পরিশোধ করুন, তারপর প্রয়োজন হলে উপজেলা বা থানায় গিয়ে বায়োমেট্রিক ভেরিফিকেশন সম্পন্ন করুন। ভেরিফিকেশন সঠিক না হলে আবেদন প্রত্যাখ্যান হতে পারে।"
  - title: "ধাপ ৪: কার্ড প্রস্তুতি ও হাতে পাওয়া"
    description: "আবেদন শেষে প্রক্রিয়াকরণ, কার্ড প্রিন্টিং ও ডেলিভারি চক্র সম্পন্ন হয়। SMS বা অফিসিয়াল নোটিশ দেখে আপনার কার্ড কবে অর্ডার হয়েছে তা নিশ্চিত করে নিন।"
---
...
সর্বশেষ ২০২৬ সালের নিয়ম অনুযায়ী, NID হারিয়ে গেলে **অনলাইনে ডুপ্লিকেট আবেদন**, **প্রয়োজনীয় তথ্য যাচাই**, **ফি পরিশোধ** এবং **প্রয়োজন হলে স্থানীয় নির্বাচন অফিস/থানা অফিসে ভেরিফিকেশন**—এই চারটি ধাপেই কাজ এগোয়। তাই প্রথমে একটু মনিটর করে বুঝে নিন এখানে কী কী থাকছে, কী কী লাগছে, আর কী কী ভুল না করলে আপনাকে আবার ফিরে যেতে হবে।
...
এখানে মানুষজনের সবচেয়ে সাধারণ ভুল হলো **ফটো সাইজ বা ফাইল ফর্ম্যাট** ঠিক না করা। উদাহরণস্বরূপ, একটি ছবি ৫০ কেবি বা ১ মেগাবাইটের মতো নির্দিষ্ট সীমার বাইরে গেলে আপলোড হতে চায় না। তাই **ছবির সাইজ ঠিক রাখুন**, এবং **ব্যক্তিগত তথ্য** লেখা করার সময় বাংলা ও ইংরেজি কনফিগারেশন ঠিক রাখুন।
...
দেখতে পারছেন, এই ধাপটা একটু কড়া। তাই সাধারণ ভুল হলো, “আমি ফে দিয়ে দিলাম, আর বাকি কাজ অফিস করে দেবে।” কিন্তু বাস্তবে **ভেরিফিকেশন সঠিক না হলে আবেদনটা ফেরত যেতে পারে**। এজন্য আপনার তথ্যগুলো আবার কচলি করে দেখে নিন—আশা করব, আপনার নিজের নোংরা শার্টের মতো না, বরং ঠিকঠাক।
...
শেষ ধাপে এসে মূলত ডুপ্লিকেট NID তৈরি, **প্রিন্টিং**, **দ্বিতীয় স্তরের যাচাই** এবং **পাঠানো বা গ্রহণ**—এই সবকিছু চলে। সাধারণত আবেদন সম্পন্ন হওয়ার পর **১৫ থেকে ৩০ কার্যদিবস** এর মধ্যে কার্ড প্রস্তুত বা হস্তান্তর করা হয়। তবে অনুমোদন, জেলার প্রক্রিয়াকরণ ক্ষমতা, ফাইল ভেরিফিকেশন, এমনকি মেইল বা ডেলিভারি চক্র—এসবের ওপর নির্ভর করে সময় একটু বাড়তে পারে।

যে মানুষজন অনলাইনে আবেদন করে, তারা অনেকেই **SMS** বা **পোর্টালের নোটিশ** দেখে জানে যে কার্ডটি প্রস্তুত হয়েছে। তাই আবেদন করার পর **সার্ভিস পোর্টাল** বা **মোবাইল নম্বর** ঘন ঘন চেক করতে থাকুন। কার্ড হাতে পেলে, সেটি **নতুন নং** দিয়ে নিরীক্ষণ করে নিন।
...
এই পর্যায়ে আপনার কাজ হলো: **আবেদনটি স্ট্যাটাস চেক করা**, **সামঞ্জস্যপূর্ণ তথ্য** নিশ্চিত করা, এবং **যদি কোনো সমস্যা থাকে, তবে অফিসিয়াল হেল্পলাইন বা local service center**-এ যোগাযোগ করা। এই টুকু কৌশলেই আপনি অনেক ঝামেলা থেকে বাঁচতে পারেন।

## খরচ ও সময়সীমা

এখন আসি那个 জরুরি প্রশ্নে—**কত খরচ হবে, আর কত দিন লাগবে?** একটি পরিষ্কার টেবিল দিয়ে এই অংশটি সহজ করে দিই।
...
হ্যাঁ, খুব জরুরি। NID হারিয়ে গেলে অনেক ক্ষেত্রে ব্যাংক, শিক্ষা, সিম, ভোটার সেবা বা সরকারি স্বার্থে সমস্যা হতে পারে। তাই যত দ্রুত সম্ভব ডুপ্লিকেট আবেদন শুরু করা উচিত। আর যদি কার্ডটি খুব জরুরি প্রয়োজন হয়, তাহলে অফিসিয়াল সার্ভিস পোর্টাল বা স্থানীয় অফিসে যোগাযোগ করে দ্রুত ভেরিফিকেশন ব্যবস্থা করতে পারেন।

### NID হারিয়ে গেলে কত টাকা লাগে?

সর্বশেষ ২০২৬ সালের নিয়ম অনুযায়ী, সাধারণত **ডুপ্লিকেট NID-র জন্য ৩৪০ টাকা** ধার্য করা হয়। তবে এই ফি নির্ভর করে নির্দিষ্ট সেবার ধরন, সংশোধন বা ভেরিফিকেশন প্রক্রিয়ার ওপর। তাই পোর্টাল বা অফিসিয়াল নোটিশে চূড়ান্ত ফি দেখে নিন।

### ডুপ্লিকেট NID কতদিনে পেতে পারি?

সাধারণত আবেদন শেষ হওয়ার পর **১৫ থেকে ৩০ কার্যদিবস** এর মধ্যে নতুন কার্ড বা ডুপ্লিকেট কার্ড প্রস্তুত হয়ে যায়। কখনও কখনও কাগজপত্র যাচাই বা ডেলিভারি চক্রের কারণে একটু বেশি সময় নিতে পারে। তাই পোর্টালটি ঘন ঘন চেক করুন, SMS বা নোটিশ পেলে তা নিশ্চিত করুন।
